...
public class OrderActivityBasicTest {
    ...
    public void clickDecrementButton_ChangesQuantityAndCost() {
        onView(withId(R.id.quantity_text_view)).check(matches(withText("0"))); //Checks if initial quantity is zero

        // Click on Decrement button and checks if value goes below zero
